            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a class="topbar-logo" href="./">
                       <img src="<?php  echo base_url() ?>public/public_admin/images/logo-light2x.png" srcset="images/logo-light2x.png 2x" alt="logo">
                    </a>
                    <ul class="topbar-nav">
                        <li class="topbar-nav-item relative">
                            ...
                            <ul class="navbar-dropdown">
                                ...
                                <li class="has-dropdown"><a class="drop-toggle" href="#">KYC / AML</a>
                                    <ul class="navbar-dropdown">
                                        ...
                                        <li><a href="<?php echo base_url(); ?>kyc_list">KYC Lists - Admin</a></li>
                    ...
                    <div class="kyc-status card mx-lg-4">
                        <div class="card-innr">
                            <div class="status status-empty">
                                ...
                                <a href="<?php  echo base_url(); ?>home/kyc_form" class="btn btn-primary">Click here to complete your KYC</a>
                            </div>
                        </div>
                    </div><!-- .card -->
