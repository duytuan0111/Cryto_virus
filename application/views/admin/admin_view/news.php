    ...
    <div class="page-content">
        <div class="container">
            <div class="card content-area">
                <div class="card-innr">
                    <div class="card-head">
                        <h4 class="card-title">Cryto Virus News</h4>
                        <div class="gaps-2x"></div>
                        <a href='#modal-id' data-toggle="modal" class="btn btn-primary">Add News</a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo base_url(); ?>admin/CrytoVirusAdmin_1278792_263840balance_login29104662/add_news" method="post" onsubmit="return checkForm(this)" id="add_news">
                                            ...
                                            <div class="input-item">
                                                <input type="text" name="img_url" id="img_url" placeholder="Image url News" class="input-bordered">
                                            </div>
                                            <div class="input-item">
                                                <input type="text" name="new_url" id="new_url" placeholder="Url News" class="input-bordered">
                                            </div>
