     ...
     <div class="col-md-11 col-xl-11 col-lg-11 text-center text-sm-left" style="padding-left: 0px !important">
      ...
      <div class="col-sm-2 col-md-2 col-lg-3 col-xl-3" style="">
        <div class="status-info">
          ...
          <h3 class="fz-3 fw-3 status-percent" style="color: white" >$0.0025</h3>
        </div>
      </div>
...
<section class="faq-section bg-faq padding-tb"  id="#">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-sm-8 col-12">
          ...
          <div class="col-lg-8 col-sm-8 col-12">
            ...
            <h3 class="text-center" style="margin-bottom: 36px; color: #FF8C00">Disease Prevention Fund</h3>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                    <td><?php 
                      if ($key['rank'] == 1) {
                        echo '<img src="http://localhost:8089/covid19/public/assets/images/medal/firstpm.jpg" alt="">';
                      }
                      else
                      {
                        echo $key['rank'];
                    ...
                    <td><?php echo $key['tokens_number'] ?></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
  ...
  // <img src="<?php echo base_url(); ?>public/assets/images/medal/firstpm.jpg" alt="">
  // <img src="<?php echo base_url(); ?>public/assets/images/medal/secendpm.jpg" alt="">
  // <img src="<?php echo base_url(); ?>public/assets/images/medal/thirdpm.jpg" alt="">

  <script >
      jQuery(document).ready(function($) {
        var email = 'thailinh@gmail.commmmmm';
        function BindingEmail(email){
            var pos = email.length;
            var pos_cham = email.lastIndexOf('.');
            var cut_email_1 = email.slice(0, 2);
            var cut_email_2 = email.substr(pos_cham);
